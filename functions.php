...
function spring_scripts_with_jquery()  
	{  
        ...
        //wp_register_script( 'less', '//cdnjs.cloudflare.com/ajax/libs/less.js/1.6.3/less.min.js'); 
...
function responsive_custom_background_cb() {  
    ...
    if ( $background ) {  
        ...
        $backgroundLarge = wp_get_attachment_image_src($backgroundId, [1024,768])[0]; 
        $backgroundMobile = wp_get_attachment_image_src($backgroundId, [768,767])[0];   
